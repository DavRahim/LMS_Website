...
const Hero = ({ }: Props) => {
    ...
    return (
        <>
          {
                isLoading ? (<Loader />) : (<div className='w-full 1000px:flex items-center pb-16 mx-auto'>
                    <div className='1000px:w-[40%] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[600px] 1100px:w-[600px] h-[50vh] w-[50vh] hero_animation rounded-full'>
                        ...
                        <div className='1000px:w-[90%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10'>
                            <Image src={data?.layout?.banner?.image?.url}
                                width={400}
                                height={400}
                                alt="banner" className='object-contain 1100px:max-w-[90%] w-[90%] 1500px:max-w-[85%] h-[auto] z-[10]' />
