...
const DashboardWidgets: FC<Props> = ({ open }: Props) => {
    const [ordersComparePercentage, setOrderComparePercentage] = useState<any>();
    ...
    }, [isLoading, data, ordersData, ordersLoading])
                    ...
                    <div className="w-full dark:bg-[#111C43] rounded-sm shadow my-8">
                        <div className="flex items-center p-5 justify-between">
                            <div className="">
                                ...
                                <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px]">{userComparePercentage?.currentMonth}
