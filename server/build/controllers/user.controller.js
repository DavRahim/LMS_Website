...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield redis_1.redis.set(user._id, JSON.stringify(user), "EX", 604800); //7day 604800
        // res.status(200).json({
        //   status: "success",
        //   accessToken,
        // });
...
exports.updatePassword = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!oldPassword || !newPassword) {
            return next(new ErrorHandler_1.default("Please enter your old & new password", 400));
        }
...
// Deleted user ---> only for admin
exports.deletedUser = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
